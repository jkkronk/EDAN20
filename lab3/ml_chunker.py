...
if __name__ == '__main__':
    ...
    train_corpus = 'train.txt'#'../../../corpus/conll2000/train.txt'
    test_corpus = 'test.txt'#'../../../corpus/conll2000/test.txt'
    ...
    training_start_time = time.perf_counter()#time.clock()
    print("Training the model...")
    classifier = linear_model.LogisticRegression(penalty='l2', dual=True, solver='liblinear')
    model = classifier.fit(X, y)
    print(model)

    test_start_time = time.perf_counter()#time.clock()
    ...
    end_time =time.perf_counter()# time.clock()
